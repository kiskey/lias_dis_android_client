...
# =====================================================================
# Batch: 005
# Name: Plan 3.0 acceptance matrix documentation
# Run from: repository root
#
# Scope:
#   Adds migration validation documentation only.
#   Does not change code, APIs, behavior, settings, or contracts.
# =====================================================================
...
cat > docs/compose_cupertino_plan30_acceptance_matrix.md <<'EOF'
...
echo "Batch 005 applied: Plan 3.0 acceptance matrix documentation added."
