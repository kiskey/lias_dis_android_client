...
| Active Enforcements | Home renders global, device, and tag enforcement from server-authoritative effective-status data while preserving existing Home features/actions |
