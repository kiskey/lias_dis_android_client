...
// Version: 28.1.0
//
// Crash-safe Cupertino-style wheel picker sheets.
//
// Compose-Cupertino 0.1.0-alpha04 high-level DatePicker/TimePicker
// wrappers are experimental and crashed on the target Android device.
// This file keeps the wheel interaction but uses stable Compose
// LazyColumn + snapping with Cupertino typography/sheet styling.
// ====================================================================
...
fun ScheduleDatePickerSheet(
    ...
    val firstYear =
        min(today.year - 2, initial.year - 1)

    val lastYear =
        max(today.year + 10, initial.year + 1)
...
private fun TextWheel(
    ...
    val safeInitial =
        initialIndex.coerceIn(values.indices)
    ...
    Box(
        ...
        LazyColumn(
            ...
            contentPadding = PaddingValues(
                vertical =
                    (WHEEL_HEIGHT - WHEEL_ROW_HEIGHT) / 2
            ),
